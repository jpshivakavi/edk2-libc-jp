...
#if defined(HAVE_GETPID) || defined(UEFI_C_SOURCE)
...
#if defined(HAVE_WAITPID) || defined(UEFI_C_SOURCE)
...
os_waitpid(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    PyTuple_SetItem(return_value, 0, PyLong_FromLong(0));
    PyTuple_SetItem(return_value, 1, PyLong_FromLong(0));
    return return_value;
}
#endif
...
#if (defined(HAVE_SYS_WAIT_H) && defined(WIFSTOPPED)) || defined(UEFI_C_SOURCE)
...
{
    PyObject *return_value = NULL;
    return_value = PyBool_FromLong((long)-1);
    return return_value;
}
#endif
...
#if (defined(HAVE_SYS_WAIT_H) && defined(WIFSIGNALED)) || defined(UEFI_C_SOURCE)
...
#if (defined(HAVE_SYS_WAIT_H) && defined(WIFEXITED)) || defined(UEFI_C_SOURCE)
...
#if (defined(HAVE_SYS_WAIT_H) && defined(WEXITSTATUS)) || defined(UEFI_C_SOURCE)
...
{
    PyObject *return_value = NULL;
    return_value = PyLong_FromLong((long)-1);
    return return_value;
}
#endif
...
#if (defined(HAVE_SYS_WAIT_H) && defined(WTERMSIG)) || defined(UEFI_C_SOURCE)
...
#if (defined(HAVE_SYS_WAIT_H) && defined(WSTOPSIG)) || defined(UEFI_C_SOURCE)
...
#if (defined(WIFEXITED) || defined(MS_WINDOWS)) || defined(UEFI_C_SOURCE)
