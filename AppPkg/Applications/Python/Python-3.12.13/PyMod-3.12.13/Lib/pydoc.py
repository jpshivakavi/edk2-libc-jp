...
def getpager():
    ...
    if sys.platform == 'uefi':
        # UEFI has no process creation, so every pager below is unreachable:
        # pipepager raises PermissionError out of fork_exec, and the 'less'
        # probe hands a command to the Shell that prints on the console.
        return plainpager
