/* pyconfig.h  Config file for X64 EFI  */
...
/* Define 1 if you have system() function */
...
/* Define to 1 if you have the <efi/time.h> header file. */
#define HAVE_EFI_TIME_H 1
...
#define USE_STACKCHECK 1

#define HAVE_FFI_PREP_CLOSURE_LOC 1
#define HAVE_DA_SERIAL 1

/* Match desktop CPython: enable object freelists (MSVC rejects empty structs when disabled). */
