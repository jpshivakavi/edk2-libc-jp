...
| 2026-09-04 | [`2026-09-04_unified_FULL_post_pymod_smoke.md`](./2026-09-04_unified_FULL_post_pymod_smoke.md) — **VS2022 + GCC FULL** @ **`3afa03f5`** (same code state): first hardware run **after PyMod consolidation**; Phase 8 spot-check (**`ssl.create_default_context()`**) + Shell **`exit`** + relaunch on both |
